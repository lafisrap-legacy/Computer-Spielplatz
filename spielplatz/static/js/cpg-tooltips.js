window.ScratchpadAutosuggestData._pjsFunctions = {
    type: $._("function"),
    whitelist: [{
        name: "rect(x, y, Breite, Höhe, Radius*)",
        exampleURL: "/cs/rectx-y-w-h/839496660",
        description: $._("Zeichnet ein Rechteck, wobei die ersten beiden Koordinaten die linke obere Ecke bezeichnen und die beiden anderen die Breite und die Höhe. Um die Position zu ändern, siehe rectMode()"),
        params: [$._("x: Die x-Koordinate der linken oberen Ecke"), $._("y: Die y-Koordinate"), $._("Breite: Die Breite des Rechtecks"), $._("Höhe: Die Höhe des Rechtecks"), $._("Radius: (optional) Der Radius der Ecken des Rechtecks")]
    }, {
